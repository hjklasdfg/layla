...
data layer. We **ingest raw open data and fuse it locally**; **routing is NOT done
here** — `get_walkable_graph` hands back the graph + per-edge attributes for the
routing layer to weight.
